...
const Page = () => {
  return (
    <section className='flex relative'>
      <div className="  w-[70%] flex flex-col gap-6 p-10  bg-white shadow-md">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full font-medium shadow transition">
              Apply Now
            </button>
